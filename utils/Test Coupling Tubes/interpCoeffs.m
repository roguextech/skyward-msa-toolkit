function [coeffsValues, coeffsValueP, angle0] = interpCoeffs(t, alpha, M, beta, alt, c, settings)
%{
...
for i = 1:15
    ...
    VP = CmatP(index(1), index(2), index(3), index(4), c);
