function [coeffsValues, angle0, coeffsValuesP] = interpCoeffsTCT(t, alpha, M, beta, alt, c, settings)
%{
...
CoeffsP = settings.CoeffsP;  % Payload Coefficients
...
if alpha < 0
    instP = [alpha + alpha*0.5, M, beta, alt];
else
    instP = [alpha + alpha*0.5, M, beta, alt];
end
